...
**ulackroad homescreen** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
- **GitHub:** https://github.com/BlackRoad-OS/blackroad-homescreen
- **Live:** https://blackroad-homescreen.pages.dev (or custom domain)
